...
Open the Slack directory and add the code below to the following file
...
document.addEventListener("DOMContentLoaded", function() {
   ...
   const cssPath = 'https://raw.githubusercontent.com/jguyton/slack-black-theme/master/custom.css';
